...
AUDIENCES_FIELDS = {
    "id": {"old_key": "", "display_name": "Id", "type": "text"},
    "web_id": {"old_key": "", "display_name": "Web Id", "type": "int"},
    "name": {"old_key": "", "display_name": "Name", "type": "text"},
    "permission_reminder": {"old_key": "", "display_name": "Permission Reminder", "type": "text"},
    "use_archive_bar": {"old_key": "", "display_name": "Use Archive Bar", "type": "bool"},
    ...
    "notify_on_subscribe": {"old_key": "", "display_name": "Notify On Subscribe", "type": "text"},
    "notify_on_unsubscribe": {"old_key": "", "display_name": "Notify On Unsubscribe", "type": "text"},
    "date_created": {"old_key": "", "display_name": "Date Created", "type": "date"},
    "list_rating": {"old_key": "", "display_name": "List Rating", "type": "float"},
    "email_type_option": {"old_key": "", "display_name": "Email Type Option", "type": "bool"},
    "subscribe_url_short": {"old_key": "", "display_name": "Subscribe Url Short", "type": "text"},
    "subscribe_url_long": {"old_key": "", "display_name": "Subscribe Url Long", "type": "text"},
    "beamer_address": {"old_key": "", "display_name": "Beamer Address", "type": "text"},
    "visibility": {"old_key": "", "display_name": "Visibility", "type": "text"},
    "double_optin": {"old_key": "", "display_name": "Double Optin", "type": "bool"},
    "has_welcome": {"old_key": "", "display_name": "Has Welcome", "type": "bool"},
    "marketing_permissions": {"old_key": "", "display_name": "Marketing Permissions", "type": "bool"},
    # 'modules': {
    #     'old_key': '',
...
AUDIENCES_STATS_FIELDS = {
    ...
    "open_rate": {"old_key": "", "display_name": "Open Rate", "mailchimp_path": ("stats", "open_rate"), "type": "int"},
    "target_sub_rate": {
        "old_key": "",
...
AUDIENCE_SEGMENTS_FIELDS = {
    "audience_id": {"old_key": "", "display_name": "Audience ID", "type": "text"},
    "audience_name": {"old_key": "", "display_name": "Audience Name", "type": "enum"},
    "name": {"old_key": "", "display_name": "Name", "type": "text"},
    "id": {"old_key": "", "display_name": "ID", "type": "int"},
    "member_count": {"old_key": "", "display_name": "Member Count", "type": "int"},
    "type": {"old_key": "", "display_name": "Type", "type": "text"},
    "created_at": {"old_key": "", "display_name": "Created At", "type": "date"},
    "updated_at": {"old_key": "", "display_name": "Updated At", "type": "date"},
    "options": {"old_key": "", "display_name": "Options", "type": "text"},
}
...
AUDIENCE_MEMBERS_FIELDS = {
    ...
    "audience_name": {"old_key": "", "display_name": "Audience Name", "type": "enum"},
    "id": {"old_key": "", "display_name": "ID", "type": "text"},
    "email_address": {"old_key": "", "display_name": "Email Address", "type": "text"},
    "unique_email_id": {"old_key": "", "display_name": "Unique Email ID", "type": "text"},
    # 'full_name': {  # new
    #     'old_key': '',
    ...
    # },
    "web_id": {"old_key": "", "display_name": "Web ID", "type": "int"},
    "email_type": {"old_key": "", "display_name": "Email Type", "type": "enum"},
    "status": {"old_key": "", "display_name": "Status", "type": "enum"},
    "unsubscribe_reason": {"old_key": "", "display_name": "Unsubscribe Reason", "type": "text"},  # new
    "consents_to_one_to_one_messaging": {"old_key": "", "display_name": "One to One", "type": "bool"},  # new
    # 'merge_fields': {  # The merge_fields will contain all custom contact fields
    #     'old_key': '',
    #     'display_name': 'Merge Fields',
    #     'type': 'text'
    # },
    "interests": {"old_key": "", "display_name": "Interests", "type": "text"},  # new
    "avg_open_rate": {
        "old_key": "",
    ...
    "ip_signup": {"old_key": "", "display_name": "Signup IP", "type": "text"},
    "timestamp_signup": {"old_key": "", "display_name": "Signup Timestamp", "type": "date"},
    "ip_opt": {"old_key": "", "display_name": "Opt IP", "type": "text"},
    "timestamp_opt": {"old_key": "", "display_name": "Opt Timestamp", "type": "date"},
    "member_rating": {"old_key": "", "display_name": "Member Rating", "type": "int"},
    "last_changed": {"old_key": "", "display_name": "Last Changed", "type": "date"},
    "language": {"old_key": "", "display_name": "Language", "type": "enum"},
    "vip": {"old_key": "", "display_name": "VIP", "type": "bool"},
    "email_client": {"old_key": "", "display_name": "Email Client", "type": "text"},
    "location_country": {
        "old_key": "",
    ...
    "source": {"old_key": "", "display_name": "Source", "type": "enum"},
    "tags_count": {"old_key": "", "display_name": "Tags Count", "type": "int"},
    "tags": {"old_key": "", "display_name": "Tags", "type": "enum", "is_list": True},
}
...
SEGMENT_MEMBERS_FIELDS = {
    "audience_id": {"old_key": "", "display_name": "Audience ID", "type": "text"},
    "audience_name": {"old_key": "", "display_name": "Audience Name", "type": "enum"},
    "segment_id": {"old_key": "", "display_name": "Segment ID", "type": "text"},
    "segment_name": {"old_key": "", "display_name": "Segment Name", "type": "text"},
    "id": {"old_key": "", "display_name": "ID", "type": "text"},
    "email_address": {"old_key": "", "display_name": "Email Address", "type": "text"},
    "unique_email_id": {"old_key": "", "display_name": "Unique Email Id", "type": "text"},
    "email_type": {"old_key": "", "display_name": "Email Type", "type": "enum"},
    ...
    "ip_signup": {"old_key": "", "display_name": "Ip Signup", "type": "text"},
    "timestamp_signup": {"old_key": "", "display_name": "Timestamp Signup", "type": "date"},
    "ip_opt": {"old_key": "", "display_name": "Ip Opt", "type": "text"},
    "timestamp_opt": {"old_key": "", "display_name": "Timestamp Opt", "type": "date"},
    "member_rating": {"old_key": "", "display_name": "Member Rating", "type": "int"},
    "last_changed": {"old_key": "", "display_name": "Last Changed", "type": "date"},
    "language": {"old_key": "", "display_name": "Language", "type": "enum"},
    "vip": {"old_key": "", "display_name": "Vip", "type": "bool"},
...
AUDIENCE_TAGS_FIELDS = {
    "id": {"old_key": "", "display_name": "ID", "type": "text"},
    "name": {"old_key": "", "display_name": "Name", "type": "enum"},
    "audience_id": {"old_key": "", "display_name": "Audience ID", "type": "text"},
    "audience_name": {"old_key": "", "display_name": "Audience Name", "type": "text"},
}
