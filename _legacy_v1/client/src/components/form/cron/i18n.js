export const defaultLocales = {
  ro: {
    every: 'Fiecare',
    mminutes: 'minut(e)',
    hoursOnMinute: 'ore la minutul',
    daysAt: 'zile la',
    at: 'la',
    onThe: 'În ziua',
    dayOfEvery: 'la fiecare',
    monthsAt: 'lună/luni, la',
    everyDay: 'Fiecare',
    mon: 'Lun',
    tue: 'Mar',
    wed: 'Mie',
    ...
    sat: 'Sam',
    sun: 'Dum',
    hasToBeBetween: 'Trebuie să fie între',
    and: 'și',
    minutes: 'Minute',
    hourly: 'Oră de oră',
    daily: 'Zilnic',
...
export function createI18n(customLocales, locale) {
  const allLocales = Object.assign(
    Object.assign({}, defaultLocales),
    customLocales
  )
