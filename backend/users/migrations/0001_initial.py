    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("email", models.EmailField(max_length=254, unique=True, verbose_name="adresă de email")),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(django.db.models.functions.text.Lower("email"), name="email_unique")
                ],
            },
            managers=[
